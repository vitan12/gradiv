FROM vsriram3@illinois.edu

RUN pip install requests
RUN pip install BeautifulSoup

# From Docker's official MongoDB template
...
CMD ["mongod"]
CMD ["use gradb"]
CMD ["db.testCol.insert({"hello":"world"})"]
CMD ["exit"]

CMD ["python3 -m venv gradiv-venv"]
CMD ["export FLASK_APP=gradiv-app.py"]
CMD ["flask run"]